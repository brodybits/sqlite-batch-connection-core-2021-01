...
public class SCCoreGlue {
  ...
  /** Interface to C language function: <br> <code> int scc_bind_parameter_index(int connection_id, const char *  name); </code>    */
  public static native int scc_bind_parameter_index(int connection_id, String name);
