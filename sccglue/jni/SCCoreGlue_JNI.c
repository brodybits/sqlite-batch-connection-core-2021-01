/* !---- DO NOT EDIT: This file autogenerated by com/jogamp/gluegen/JavaEmitter.java on Thu Sep 02 11:00:03 EDT 2021 ----! */
...
/*   Java->C glue code:
 *   Java package: io.sqlc.SCCoreGlue
 *    Java method: int scc_bind_parameter_index(int connection_id, java.lang.String name)
 *     C function: int scc_bind_parameter_index(int connection_id, const char *  name);
 */
JNIEXPORT jint JNICALL
Java_io_sqlc_SCCoreGlue_scc_1bind_1parameter_1index__ILjava_lang_String_2(JNIEnv *env, jclass _unused, jint connection_id, jstring name) {
  const char* _strchars_name = NULL;
  int _res;
  if ( NULL != name ) {
    _strchars_name = (*env)->GetStringUTFChars(env, name, (jboolean*)NULL);
  if ( NULL == _strchars_name ) {
      (*env)->ThrowNew(env, (*env)->FindClass(env, "java/lang/OutOfMemoryError"),
                       "Failed to get UTF-8 chars for argument \"name\" in native dispatcher for \"scc_bind_parameter_index\"");
      return 0;
    }
  }
  _res = scc_bind_parameter_index((int) connection_id, (char *) _strchars_name);
  if ( NULL != name ) {
